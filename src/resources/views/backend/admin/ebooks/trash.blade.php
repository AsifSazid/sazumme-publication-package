                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="overflow-x-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex justify-center space-x-2">
                                                <form action="{{ route('admin.ebooks.restore', $trashed->uuid) }}"
                                                ...
                                                <form action="{{ route('admin.ebooks.forceDelete', $trashed->uuid) }}"
                                                    method="POST" class="inline ml-2"
                                                    onsubmit="return confirm('Permanently delete this ebook?');">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        <div
                            ...
                            <a href="{{ route('admin.ebooks.index') }}" class="text-blue-500 hover:text-blue-700 mx-1"
                                title="Ebook Lists"><i class="fas fa-trash-alt"></i> Ebook Lists</a>
                        </div>
                    </div>
                </div>
            </div>
