                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-center">
                                    <h3 class="text-xl font-semibold text-gray-800 mb-2">{{ $ebook->title }}</h3>
                                    <p class="px-4">
                                        <strong>{{ $ebook->wing->title ?? 'Main Website' }}</strong> </p>
                                </div>
                            ...
                            <div class="p-4">
                                <div class="mb-4 text-gray-600 flex justify-between items-center">
                                    <p><strong>Starts At:</strong>
                                        {{ $ebook->starts_at?->format('d-M-Y H:i') ?? 'N/A' }}</p>
                                    <p><strong>Ends At:</strong>
                                        {{ $ebook->ends_at?->format('d-M-Y H:i') ?? 'N/A' }}</p>
                                </div>
